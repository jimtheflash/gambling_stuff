...
train_test_split <- rsample::initial_split(to_model, prop = 3/4, strata = strata_var)
...
lasso_final_params <- lasso_tg %>%
  tune::select_best("rmse")

lasso_final_wf <- lasso_workflow %>%
  tune::finalize_workflow(lasso_final_params)
